  ...
  >
    <div className="flex flex-col md:flex-row items-center md:items-start">
      ...
      <div className="flex-1 mt-4 md:mt-0 md:ml-52 text-center md:text-left">
        <h2 className="whitespace-nowrap font-futuraMedium font-[500] text-[40px] sm:text-[20px] md:text-[30px] lg:text-[40px] leading-[50.52px] sm:leading-[50.52px] md:leading-[50.52px]  lg:leading-[50.52px] mb-2 sm:mb-3 md:mb-4">
