...
>
  <div
    className="relative z-20 flex flex-col items-center px-4 sm:px-8 bg-cover bg-center bg-blend-overlay w-full h-auto sm:h-[85vh] md:h-[90vh] -mt-8"
    style={{
  ...
  >
    ...
    {/* Heading */}
    <h1 className="text-[30px] sm:text-[40px] md:text-[50px] font-[700] sm:font-[700] text-white font-futuraLight mt-16 leading-[40px] sm:leading-[50px] md:leading-[60px]">
      Hello there!
      <br />
      <span
        className="bg-clip-text text-transparent sm:font-[700] text-[24px] sm:text-[30px] md:text-[40px] font-futuraLight leading-[28px] sm:leading-[40px]"
        style={{
          backgroundImage:
